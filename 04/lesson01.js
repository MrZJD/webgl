...
ready(() => {
	...
	var tranAndRotMatrix = new Matrix4();
    tranAndRotMatrix.setRotate(tAngle, 0, 0, 1);
    tranAndRotMatrix.translate(tx, 0.0, 0.0); //先平移后旋转

    var rotAndTranMatrix = new Matrix4();
    rotAndTranMatrix.setTranslate(tx, 0.0, 0.0);
    rotAndTranMatrix.rotate(tAngle, 0, 0, 1); //先旋转后平移
	...
	webgl.uniformMatrix4fv(u_xformMatrix, false, rotAndTranMatrix.elements);
